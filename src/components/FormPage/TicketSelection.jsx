    ...
    <div className="md:mt-9 rounded-[40px] md:bg-customNavbg md:border border-cyan-500 bg-opacity-70 backdrop-filter backdrop-blur-lg p-[20px] md:p-[24px]">
      ...
      <div className="w-full">
        <Select value={selectedValue} onValueChange={handleSelectValue}>
          ...
          <SelectContent className=" w-[300px] md:w-[400px] mt-3 h-36 md:h-auto bg-section overflow-scroll md:overflow-visible bg-opacity-80 rounded-[12px] px-4 p-[8px] text-white" style={{ border: "1px solid #0E464F" }} position="popper">
